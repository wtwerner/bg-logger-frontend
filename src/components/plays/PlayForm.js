...
const PlayForm = ({ loginFormData, updateLoginForm, login }) => {
...
const mapStateToProps = state => {
    return {
        playFormData: state.loginForm
    }
}

export default connect(mapStateToProps, { updatePlayForm, recordPlay } )(PlayForm)